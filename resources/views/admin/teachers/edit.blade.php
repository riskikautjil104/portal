                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="md:col-span-1 flex flex-col items-center">
                            ...
                            <div class="w-40 h-40 rounded-full overflow-hidden border-4 border-blue-50 shadow-md bg-gray-50 flex items-center justify-center relative group">
                                @if($teacher->photo)
                                    <img id="photo-preview" src="{{ asset('storage/' . $teacher->photo) }}" class="w-full h-full object-cover">
                        ...
                        <div class="md:col-span-2 space-y-5">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $teacher->name) }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" placeholder="Contoh: Budi Santoso, S.Pd." required>
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" name="nip" id="nip" value="{{ old('nip', $teacher->nip) }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" placeholder="Contoh: 198203102009021003">
                                @error('nip')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="subject" id="subject" value="{{ old('subject', $teacher->subject) }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" placeholder="Contoh: Guru Matematika / Wakil Kepala Sekolah" required>
                                @error('subject')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
